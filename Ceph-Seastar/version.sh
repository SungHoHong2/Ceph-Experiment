...
echo "LIBRARIES NOT FOUND: install_depths.sh whenever your rerun your computer"
echo "INSTALLING CEPH: ./do_cmake.sh -DWITH_MGR_DASHBOARD_FRONTEND=OFF -DWITH_DPDK=OFF -DWITH_SPDK=OFF"
...
cd /home/sungho/ceph/build/src && c++ -std=c++17  $SEASTAR_LIBRARY -fdiagnostics-color=auto -I/usr/include -fno-builtin-malloc -fno-builtin-calloc -fno-builtin-realloc -fno-builtin-free -O2 -g    -pie CMakeFiles/ceph-osd.dir/ceph_osd.cc.o  -o ../bin/ceph-osd ../lib/libosd.a ../lib/libos.a ../lib/libglobal-static.a ../lib/libceph-common.so.0 -lblkid -libverbs -lfuse ../lib/libdmclock.a -laio -lfuse  -lrt  -luuid ../lib/libkv.a -lleveldb rocksdb/librocksdb.a -lsnappy -llz4 ../lib/libcommon.a ../lib/libjson_spirit.a ../lib/libcommon_utf8.a ../lib/liberasure_code.a -lresolv -lblkid ../boost/lib/libboost_thread.a ../boost/lib/libboost_chrono.a ../boost/lib/libboost_atomic.a ../boost/lib/libboost_system.a ../boost/lib/libboost_random.a ../boost/lib/libboost_program_options.a ../boost/lib/libboost_date_time.a ../boost/lib/libboost_iostreams.a ../boost/lib/libboost_regex.a -lssl3 -lsmime3 -lnss3 -lnssutil3 -lplds4 -lplc4 -lnspr4 -lssl -lcrypto -lpthread -ldl -ludev -libverbs -lz -Wl,-rpath,/home/sungho/ceph/build/lib:
